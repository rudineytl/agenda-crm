...
@Component({
  ...
  template: `
    <div class="min-h-screen flex flex-col md:flex-row bg-white overflow-hidden">
      <!-- Lado Esquerdo: Branding & Marketing (Oculto em Mobile pequeno) -->
      <div class="hidden md:flex md:w-1/2 bg-slate-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div class="relative z-10">
          <div class="flex items-center gap-3 mb-12">
            ...
            <span class="text-2xl font-black text-white tracking-tighter italic">BelezaRara</span>
          </div>
          ...
          <p class="text-slate-400 text-lg max-w-md leading-relaxed">
            Organize sua agenda, controle seu caixa e encante seus clientes com a plataforma mais rápida do mercado.
          </p>
        </div>
        ...
        <div class="relative z-10 grid grid-cols-2 gap-8">
          <div class="space-y-2">
            ...
            <p class="text-slate-500 text-sm font-medium uppercase tracking-widest">Profissionais</p>
          </div>
          <div class="space-y-2">
            <p class="text-white font-bold text-2xl">99.9%</p>
            <p class="text-slate-500 text-sm font-medium uppercase tracking-widest">Satisfação</p>
          </div>
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-col items-center justify-center p-8 md:p-16 bg-slate-50/50">
        <div class="w-full max-w-md">
          ...
          <div class="md:hidden flex items-center gap-2 mb-10 justify-center">
            ...
            <span class="text-xl font-black text-slate-800 tracking-tighter italic">BelezaRara</span>
          </div>
            ...
            @if (!codeSent()) {
              ...
              <div class="space-y-4">
                <div class="relative group">
                  <label class="absolute left-4 top-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-widest transition-all group-focus-within:text-indigo-600">E-mail ou WhatsApp</label>
                  <input 
                    type="text" 
                    [(ngModel)]="identifier" 
                ...
                <div class="relative py-4">
                  ...
                  <div class="relative flex justify-center text-xs uppercase"><span class="bg-slate-50 px-3 text-slate-400 font-bold tracking-widest">OU TESTE AGORA</span></div>
                </div>
              ...
              <div class="space-y-6 animate-in slide-in-from-right duration-300">
                <div class="text-center p-6 bg-indigo-50 rounded-3xl border border-indigo-100">
                  <p class="text-sm text-indigo-600 font-medium">Enviamos um código de acesso para</p>
          ...
          <footer class="mt-12 text-center">
            <p class="text-xs text-slate-400 font-medium leading-relaxed">
              ...
              <a href="#" class="text-slate-600 underline">Termos de Serviço</a> e <a href="#" class="text-slate-600 underline">Política de Privacidade</a>.
            </p>
          </footer>
        </div>
      </div>
...
export class AuthComponent {
  ...
  sendCode() {
    ...
    // Em produção, aqui dispararíamos o e-mail/SMS
  }
  ...
  quickAccess() {
    this.auth.login('demo@belezarara.com');
  }
}
